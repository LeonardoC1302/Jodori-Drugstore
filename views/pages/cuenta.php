    ...
    <div class="form-cuenta">
        <form class="form">
            <div class="form__field">
                ...
                <input disabled class="form__input" type="text" placeholder="Nombre de usuario" id="name" name="name" value="<?php echo $user->username; ?>">
            </div> <!-- /form__field -->        
            <div class="form__field">
        ...
        <div class="acciones-cuenta">
            <a href="#" class="orange-btn">Actualizar</a>
            <a href="#" class="red-btn">Eliminar cuenta</a>
        </div>
    </div>
